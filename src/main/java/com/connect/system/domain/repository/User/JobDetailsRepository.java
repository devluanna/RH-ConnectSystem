...
@Repository
public interface JobDetailsRepository extends JpaRepository<JobsDetails, Integer> {
    ...
    JobsDetailsDTO findJobsById(@Param("id_job_details") Integer id_job_details);
}
